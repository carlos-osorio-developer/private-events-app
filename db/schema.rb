...
ActiveRecord::Schema.define(version: 2021_05_27_145219) do
  ...
  create_table "attendings", force: :cascade do |t|
    ...
    t.index ["attendee_id", "attended_event_id"], name: "index_attendings_on_attendee_id_and_attended_event_id", unique: true
